...
export const ContainersView = memo(function ContainersView(props: Props) {
  const { containers, loading, openContainerLogs, setConfirm, refreshContainers, canControl } = props;
  ...
  return (
    <section className="panel">
      ...
      <ContainerGroups containers={containers} loading={loading} onLogs={openContainerLogs} onConfirm={(next) => setConfirm(next)} onReload={refreshContainers} canControl={canControl} />
    </section>
  );
});
